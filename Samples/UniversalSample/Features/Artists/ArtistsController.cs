...
using Sample.Shared;
using UniversalSample.Features.Albums;
using UniversalSample.Features.Artists.All;
using UniversalSample.Features.Artists.Single;

namespace UniversalSample.Features.Artists
{
